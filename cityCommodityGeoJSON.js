...
L.GeoJSON.CityCommodity = L.GeoJSON.extend({
    ...
    _assignIndustry: function(key, base, indParams) {
        ...
        this.eachLayer( function(layer) {
            var urlParams = {
                ...
                url = base + L.Util.getParamString(urlParams);
    ...
    _censusTableUploadHandler : function(error, results) {
        ...
        // set industry parameters for census requests
        this._industryParamList = _setIndustryList(this._industries);
        ...
        // set industry list for census requests
        function _setIndustryList(industryList) {
            var indString = "&",
            ...
            for (var i=0; i<industryList.length; i++) {
                ...
                // (ie. most specific)
                if (industryList[i].industry.length == 4) {
                    indString += template.replace('%ind%', industryList[i].industry);
                }
            }
