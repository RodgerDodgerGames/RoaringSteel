...
L.Draw.Polyline = L.Draw.Feature.extend({
    ...
    _drawGuide: function (pointA, pointB) {
        ...
        for (; i < length; i += this.options.guidelineDistance) {
            ...
            // console.log(dashPoint);
            this._checkPoints.push(this._map.layerPointToLatLng(L.point(dashPoint.x, dashPoint.y)));
        ...
        // add mouse marker point
        this._checkPoints.push(this._map.layerPointToLatLng(pointB));
    },
